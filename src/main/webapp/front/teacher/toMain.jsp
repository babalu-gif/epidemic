...
<script type="text/javascript">
  ...
  $(function (){
    ...
    $("#updatePwdBtn").click(function () {
      ...
      // 表单验证
      if (oldPwd != "${sessionScope.sessionTeacher.password}"){
      ...
      $.ajax({
        url:"teacher/updatePwd.do",
        data:{
          id:"${sessionScope.sessionTeacher.id}",
          password:newPwd
        },
        type:"post",
        dataType:"json",
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div style="position: relative; left: 40px;">
            姓名：<b>${sessionScope.sessionTeacher.name}</b><br><br>
            登录帐号：<b>${sessionScope.sessionTeacher.teacherId}</b><br><br>
            邮箱：<b>${sessionScope.sessionTeacher.email}</b><br><br>
            电话：<b>${sessionScope.sessionTeacher.phone}</b><br><br>
            性别：<b>${sessionScope.sessionTeacher.sex}</b><br><br>
            住址：<b>${sessionScope.sessionTeacher.address}</b><br><br>
            管理班级：<b>${sessionScope.className}</b><br><br>
          </div>
        </div>
  ...
  <div class="box">
      ...
      <span class="headright">
        ...
        <div class="btn-group" style="float: right;right: 40px;top: 10px;display: flex">
          <button type="button" class="btn btn-default" style="flex: auto">
            <span class="glyphicon glyphicon-user">${sessionScope.sessionTeacher.name}</span></button>
    ...
    <div class="box-body">
      <div class="body-left">
        <div id="ltop">
          <div id="lts">
            <img style="width:150px;height:150px;border-radius:50%;" type="file" id="avatar" name="image" src="upload/${sessionScope.sessionTeacher.avatar}" /><br/><br/>
          </div>
        </div>
        <div id="lbottom">
          <ul class="nav nav-pills nav-stacked">
            <li><a href="admin/toState.do" target="workareaFrame">疫情状态发布</a></li>
            <li><a href="teacher/toHealthPunch.do" target="workareaFrame">健康打卡统计分析</a></li>
            <li><a href="teacher/toLeave.do" target="workareaFrame">请假申请及返校审核</a></li>
            <li><a href="teacher/toStudent.do" target="workareaFrame">学生信息</a></li>
          </ul>
        </div>
        <!-- 分割线 -->
        <div id="divider1"></div>
